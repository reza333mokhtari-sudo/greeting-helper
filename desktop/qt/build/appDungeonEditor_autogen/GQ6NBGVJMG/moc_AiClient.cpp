...
template <> constexpr inline auto AiClient::qt_create_metaobjectdata<qt_meta_tag_ZN8AiClientE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AiClient, void>(QMC::MetaObjectFlag{}, qt_stringData,
...
void AiClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->responseReceived((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AiClient::*)()>(_a, &AiClient::isLoadingChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AiClient::*)(const QString & )>(_a, &AiClient::responseReceived, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (AiClient::*)(const QString & )>(_a, &AiClient::errorOccurred, 2))
            return;
    }
...
// SIGNAL 0
void AiClient::isLoadingChanged()
{
