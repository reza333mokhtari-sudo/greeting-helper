...
function AdminConsole() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      toast.error(`'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            fix this problem in /admin \n'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.''' Query failed: ${e.message}`);
    } finally {
      setLoading(false);
    }
