          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            <Hint label="Add layer">
              <Button
                variant="outline"
                size="icon"
                className="size-7 rounded-full border-primary/20 bg-primary/5 hover:bg-primary/10"
            ...
            return (
              <li
                ...
                className={`cursor-pointer rounded-lg border px-2 py-1.5 transition-colors ${
                  ...
                  active
                    ? "border-primary/60 bg-accent/60 shadow-[var(--shadow-arcane)]"
              ...
              >
                <div className="flex items-center gap-1">
                  ...
                  <Badge
                    variant="outline"
                    className="h-5 border-border/50 bg-background/50 px-1.5 font-mono text-[9px] tabular-nums text-muted-foreground"
                  >
                          ...
                          <ContextMenu>
                            ...
                            <ContextMenuContent className="w-48">
                              ...
                              {o.kind === "image" && (
                                <>
                                  <ContextMenuItem
                                    onClick={() => p.onUpdateObject?.(o.id, { filter: "none" })}
                                  >
                                    <ImageIcon className="mr-2 size-3.5" /> No Filter
                                  </ContextMenuItem>
                                  <ContextMenuItem
                                    onClick={() => p.onUpdateObject?.(o.id, { filter: "pixel" })}
                                  >
                                    <Palette className="mr-2 size-3.5" /> Pixel Graphics
                                  </ContextMenuItem>
                                  <ContextMenuItem
                                    onClick={() => p.onUpdateObject?.(o.id, { filter: "toon" })}
                                  >
                                    <Wand2 className="mr-2 size-3.5" /> Toon Style
                                  </ContextMenuItem>
                                  <ContextMenuItem
                                    onClick={() =>
                                      p.onUpdateObject?.(o.id, { filter: "remove-bg" })
                                    }
                                  >
