  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      <div className="space-y-4 p-1">
        ...
        <Button onClick={handleAddRoom} className="w-full gap-2 text-xs h-9" variant="secondary">
        ...
        <div className="rounded-md border border-dashed border-border p-3 bg-muted/30">
          <p className="text-[10px] text-muted-foreground leading-relaxed italic">
            Tip: Procedural generation creates base geometry that you can then refine using the
            standard tools.
          </p>
        </div>
      </div>
