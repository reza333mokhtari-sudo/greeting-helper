...
export function ProfileMenu({
  ...
  onAuthRequired?: ((reason: string) => void) | undefined;
}) {
  const [activeDialog, setActiveDialog] = useState<"settings" | "help" | "faq" | "support" | null>(
    null,
  );
      ...
      content: (
        <Tabs defaultValue="general" className="w-full">
          <TabsList className="grid w-full grid-cols-4 bg-muted/50 p-1">
            <TabsTrigger value="general" className="text-[10px] font-bold uppercase tracking-tight">
              General
            </TabsTrigger>
            <TabsTrigger
              value="security"
          ...
          <ScrollArea className="h-[400px] mt-4 pr-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold">
                      {user?.user_metadata?.display_name || "Dungeon Scrawler"}
                    </h4>
            ...
            <TabsContent value="security" className="space-y-6 mt-0">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      Secure your account with multi-factor verification.
                    </p>
                  </div>
                  <Switch />
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      Receive a secure link via email instead of password.
                    </p>
                  </div>
                  <Switch checked />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      Notify me of new logins from unrecognized devices.
                    </p>
                  </div>
                  <Switch />
                </div>
              ...
              <div className="pt-4">
                <Button
                  variant="outline"
                  className="w-full text-xs font-bold uppercase h-9 border-destructive/30 text-destructive hover:bg-destructive/10"
                >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-xs font-semibold flex items-center gap-1.5">
                          {s.device}{" "}
                          {s.current && (
                            <Badge className="text-[8px] h-3.5 px-1 bg-green-500/10 text-green-500 border-green-500/20">
                              CURRENT
                            </Badge>
                          )}
                        </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      Automatically sync changes to your cloud library.
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      Enable shadows and complex CSS transitions.
                    </p>
                  </div>
                  <Switch defaultChecked />
                </div>
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      Early access to high-fidelity 3D map assets.
                    </p>
                  </div>
                  <Switch />
                </div>
          ...
          <div className="mt-6">
            <Button className="w-full shadow-xl shadow-primary/20 h-10 font-bold uppercase tracking-wider text-xs">
              Commit Updates
            </Button>
          </div>
        </Tabs>
      ...
      content: (
        <div className="space-y-4 text-sm leading-relaxed text-muted-foreground">
          ...
          <ul className="list-disc pl-4 space-y-2">
            <li>
              <strong>Drawing:</strong> Use the toolbar to create rooms (rectangles), corridors
              (paths), and custom polygons.
            </li>
            <li>
              <strong>Floors:</strong> Manage multiple levels in your dungeon using the Floors
              panel.
            </li>
            <li>
              <strong>AI Agent:</strong> Use the AI panel to generate rooms or encounters
              automatically.
            </li>
            <li>
              <strong>Export:</strong> Export your creations as PNG, SVG, or high-quality PDF.
            </li>
          </ul>
        </div>
      ),
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground">
              Open the cloud panel, make your map 'Public', and copy the share link.
            </p>
          </div>
          <div className="space-y-1">
            <h4 className="font-medium text-foreground">Can I use my own images?</h4>
            <p className="text-xs text-muted-foreground">
              Yes! Use the Props panel to upload custom textures or prop images.
            </p>
          </div>
          <div className="space-y-1">
            <h4 className="font-medium text-foreground">Is there a player view?</h4>
            <p className="text-xs text-muted-foreground">
              Yes, use the 'Player View' toggle in the View menu to see what your players see (with
              Fog of War active).
            </p>
          </div>
        </div>
      ...
      content: (
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Select
              onValueChange={(v) => ((window as any)._ticketPriority = v)}
              defaultValue="medium"
            >
    ...
    <>
      <DropdownMenu onOpenChange={(open) => open && performCheck()}>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            className="h-10 w-10 rounded-full p-0 hover:bg-primary/10 transition-colors border border-border/40 shadow-sm overflow-hidden"
          >
        ...
        <DropdownMenuContent align="end" className="w-64 p-2 shadow-2xl">
          <DropdownMenuLabel className="flex flex-col px-3 py-2">
            ...
            {user && (
              <span className="text-[10px] font-normal text-muted-foreground truncate opacity-70">
                {user.email}
              </span>
            )}
          </DropdownMenuLabel>
          ...
          <div className="grid grid-cols-2 gap-1 p-1">
            ...
            <div className="flex items-center gap-2 rounded-md bg-muted/40 px-2 py-1.5">
              ...
              <span className="text-[9px] font-bold uppercase tracking-tight text-muted-foreground">
                AUTH: {authStatus === "authenticated" ? "SECURE" : "GUEST"}
              </span>
            </div>
          </div>
          ...
          {user && (window as any)._isAdmin && (
            <DropdownMenuItem
              asChild
              className="text-xs font-bold text-blue-500 cursor-pointer py-2"
            >
              <Link to="/admin">
              ...
              <div className="p-6 pb-2">
                <DialogHeader>
                  ...
                  <DialogDescription className="text-xs">
                    {dialogs[activeDialog].desc}
                  </DialogDescription>
                </DialogHeader>
              </div>
              <div className="px-6 pb-6 pt-2">{dialogs[activeDialog].content}</div>
            </div>
          )}
        </DialogContent>
      </Dialog>
