  ...
  return (
    <header className="relative flex h-11 shrink-0 items-center gap-2 border-b border-border bg-sidebar px-2">
      ...
      <Menubar className="h-8 border-0 bg-transparent p-0 shadow-none">
        ...
        <MenubarMenu>
          <MenubarTrigger className="h-8 px-3 text-xs">i find bug for any OBJ (anything of can moveable ) has invert {"\n\n"}i dont want it including CLIENTs{"\n\n"}also REMOVE BOTTOM BAR of TOOLS bar</MenubarTrigger>
          <MenubarContent>
